<template>
  <section class="lc-container-0 lc-team" id="team">
...
export default {
  ...
  data() {
    return {
      teamMembers: teamMembers.map(this.translateTeamMember),
    };
  },
  methods: {
    translateTeamMember({ key, platforms }) {
      return {
